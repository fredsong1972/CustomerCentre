...
namespace CustomerCentre.Persistence
{
    //dotnet ef dbcontext scaffold "Server=.\sqlexpress;Database=CustomerCentre;Trusted_Connection=True;" Microsoft.EntityFrameworkCore.SqlServer -o Models -c "CustomerCentreDbContext" -f
